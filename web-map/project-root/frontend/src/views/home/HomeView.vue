<template>
  <DefaultLayout>
    ...
    <div class="hiking-tips-section">
      ...
      <a-row :gutter="[24, 24]">
        <a-col :span="8" v-for="(article, index) in articlesData" :key="index">
...
const articlesData = ref([
  {
    title: "初学者徒步装备指南",
    summary:
      "为初次徒步的爱好者提供全面的装备选购建议，从鞋子到背包，一应俱全...",
    image:
      "https://images.unsplash.com/photo-1501554728187-ce583db33af7?q=80&w=1470&auto=format&fit=crop",
    date: "2023-06-15",
    category: "装备指南",
  },
  {
    title: "高海拔徒步注意事项",
    summary:
      "高海拔环境对人体有特殊要求，本文详细介绍高海拔徒步的准备工作和应对方法...",
    image:
      "https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?q=80&w=1476&auto=format&fit=crop",
    date: "2023-06-08",
    category: "安全指南",
  },
  {
    title: "四季徒步最佳目的地推荐",
    summary:
      "根据不同季节特点，推荐最适合当季徒步的目的地，让您一年四季都能享受徒步乐趣...",
    image:
      "https://images.unsplash.com/photo-1454496522488-7a8e488e8606?q=80&w=1476&auto=format&fit=crop",
    date: "2023-05-28",
    category: "目的地",
  },
]);
...
onMounted(async () => {
  try {
    ...
    Message.error("获取热门路线失败，请刷新页面重试");
  } finally {
    loading.value = false;
  }
});
